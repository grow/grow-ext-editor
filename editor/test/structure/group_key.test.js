...
describe('group field with key', () => {
  ...
  it('should accept input', async () => {
    ...
    await percySnapshot(page, 'Group field before expand', shared.snapshotOptions)
    ...
    await percySnapshot(page, 'Group field after save', shared.snapshotOptions)
  })
  ...
  it('should accept input on localization', async () => {
    ...
    await percySnapshot(page, 'Group field after localization save', shared.snapshotOptions)
  })
})
