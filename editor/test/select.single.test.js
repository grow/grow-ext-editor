...
describe('select single field', () => {
  ...
  it('should be checked and unchecked', async () => {
    ...
    await percySnapshot(page, 'Select single field unchecked after save', defaults.snapshotOptions)
  })
  ...
  it('should be checked and unchecked on localization', async () => {
    ...
    await percySnapshot(page, 'Select single field unchecked after localization save', defaults.snapshotOptions)
  })
})
